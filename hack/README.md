...
the scripts are in. If this is not the case, you can configure the root of the 
repo by either setting `REPO_ROOT` or by calling the scripts with `--root-dir=<root>`.
